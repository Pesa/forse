...
TODO
\subsection*{Accesso alla pista}
controllo della concorrenza (scheduler).

\subsection*{Tempo di percorrenza}
Considerazioni sulla correttezza del tempo di percorrenza, algoritmo di sorpasso, rallentamento della simulazione non influenza i tempi di gara (scheduler).
