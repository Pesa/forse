...
\begin{figure}[hfp]
  \begin{center}
  \includegraphics[scale=0.35]{diagrammi/Arch.eps}
...
\end{itemize}
All'inizio della competizione car deve prenotarsi presso lo scheduler e stare poi in attesa del permesso di muoversi sulla pista dato dello scheduler.
